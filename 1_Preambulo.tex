...
\cftsetindents{subsection}{3.0em}{4.2em}
\cftsetindents{subsubsection}{4.5em}{4.2em}

% Índice de Figuras
\cftsetindents{figure}{1.5em}{3.2em}

% Índice de Tablas
\cftsetindents{table}{1.5em}{3.2em}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Comando uniforme para términos técnicos en inglés (se muestran en cursiva)
\newcommand{\ing}[1]{\textit{#1}}

\newcommand{\firmajurado}[2]{%
  \begin{center}
