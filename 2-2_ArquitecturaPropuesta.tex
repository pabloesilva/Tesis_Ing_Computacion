...
La lógica de interconexión se basa en el flujo de datos ascendente desde el \ing{hardware} de campo hacia la interfaz de usuario. Cada contenedor Docker desempeña un rol específico en esta cadena de procesamiento:
